...
echo "    curl -c /tmp/nl.cookies -b /tmp/nl.cookies -X POST -d 'userID=student&password=any' http://localhost:$PORT/Login"
echo "    curl -b /tmp/nl.cookies http://localhost:$PORT/   # signed-in landing page"
echo "    curl -X POST -d 'code=print(\"hello\")' http://localhost:$PORT/RunPython"
